...
<head>
  ...
  ================================================== -->
  <title>Ts3 Kiralama, TeamSpeak3 Özellikleri - LiderCS Online Oyun Sunucusu</title>
	...
	<div class="container">
          ...
          <div class="content col-md-12">
            ...
            <article class="card card--lg post post--single">
				<div class="widget__title card__header">
					<h2>TEAMSPEAK3 ÖZELLIKLERİ, TS3 KİRALAMA</h2>
				</div>
        ...
        <div class="row">
          <div class="col-lg-4">
            ...
            <h2>LiderCS Panel</h2>
            <p>Gelişmiş LiderCS Panelimiz İle Sunucunuzu Kontrol Edebiirsiniz.</p>
          </div>
          <div class="col-lg-4">
            <i class="fa fa-clock-o fa-5x"></i>
            <h2>%99 Uptime</h2>
            <p>%99.99 Uptime Garantisi İle Serveriniz 7/24 Açık Olacak.</p>
          </div>
          <div class="col-lg-4">
            <i class="fa fa-cloud fa-5x"></i>
            <h2>Yedek Sistemi</h2>
            <p>Eğer TS3 Serverinize Birşey Olursa Veya Yanlışlıkla Silerseniz Üzülmeyin Yedek Sistemimiz İle Hiçbirşey Kaybolmayacak.</p>
          </div>
		  
		  <div class="col-lg-4">
            <i class="fa fa-archive fa-5x"></i>
            <h2>Hazır Server</h2>
            <p>Serverlerimiz Hazır Bir Şekilde Gelir Sadece İsteğinize Göre Reklamları Düzenlersiniz.</p>
          </div>
		  <div class="col-lg-4">
            <i class="fa fa-lock fa-5x"></i>
            <h2>Güvenlik Sistemi</h2>
            <p>DDOS Ve Tüm Saldırı Türlerini Engelliyoruz Serverinizi 7/24 Koruyoruz.</p>
          </div>
		  <div class="col-lg-4">
            <i class="fa fa-comments fa-5x"></i>
            <h2>7/24 Teknik Destek</h2>
            <p>Eğer Sunucunuzda Sorun Olursa Teknik Destek Ekibimiz Sizin İçin Bekliyor Olacaktır.</p>
           
          </div>
		  
		  <div class="col-lg-4">
            <i class="fa fa-comments fa-5x"></i>
            <h2>512 Kişilik TS3 Sadece 15 TL</h2>
            <p>Eğer Sunucunuzda Sorun Olursa Teknik Destek Ekibimiz Sizin İçin Bekliyor Olacaktır.</p>
            <p><a class="btn btn-danger" href="mobil-odeme.php" role="button">Mobil Ödeme &raquo;</a></p>
			<p><a class="btn btn-secondary" href="banka-odeme.php" role="button">BANKA ÖDEME &raquo;</a></p>
          </div>
        </div><!-- /.row -->
