...
<head>
  ...
  ================================================== -->
  <title>Cs 1.6 İndir, Counter Strike 1.6 Türkçe Botlu indir, Cs1.6 Oyna</title>
  ...
  <!-- İçerik Taşıyıcı
    ...
    <div class="site-content">
	 ...
	 <section class="pricing-section bg-10">
            <h2 class="pricing-section__title">COUNTER STRIKE 1.6 İNDIR, CS1.6 TÜRKÇE BOTLU INDIR</h2>
            <div class="pricing pricing--rabten">
                <div class="pricing__item">
				<div class="icon icon--download"></div>
                    <h3 class="pricing__title">Türkçe Sorunsuz</h3>
                    <ul class="pricing__feature-list">
                        <li class="pricing__feature"><b>Orjinal</b> CS</li>
                        <li class="pricing__feature"><b>Boyut:</b> 240MB</li>
                        <li class="pricing__feature"><b>Oyun Dili:</b> Türkçe</li>
						<li class="pricing__feature"><b>Gereken Ekran Kartı:</b> 16 MB</li>
						<li class="pricing__feature"><b>Gereken RAM:</b> 64 MB</li>
						<li class="pricing__feature">Tüm Windowslarla Uyumlu</li>
                    </ul>
					<a class="btn btn-danger" href="http://www.mediafire.com/file/57rcmpn8ahzrok9/cs1.6.rar" role="button">İndir</a>
                </div>
				
				 <div class="pricing__item">
				 <div class="icon icon--download"></div>
                    <h3 class="pricing__title">Botlu Cs1.6</h3>
                    <ul class="pricing__feature-list">
                        <li class="pricing__feature"><b>Botlu</b> CS</li>
                        <li class="pricing__feature"><b>Boyut:</b> 210 MB</li>
                        <li class="pricing__feature"><b>Oyun Dili:</b> Türkçe</li>
						<li class="pricing__feature"><b>Gereken Ekran Kartı:</b> 16 MB</li>
						<li class="pricing__feature"><b>Gereken RAM:</b> 64 MB</li>
						<li class="pricing__feature">Tüm Windowslarla Uyumlu</li>
                    </ul>
					<a class="btn btn-danger" href="https://www.dosyaupload.com/5qln" role="button">İndir</a>
                </div>
				
				<div class="pricing__item">
				<div class="icon icon--download"></div>
                    <h3 class="pricing__title">Server Listesi</h3>
                    <ul class="pricing__feature-list">
						<li class="pricing__feature"><b>Online ip adresleri</b></li>
                        <li class="pricing__feature"><b>Boyut:</b> 267 KB</li>
                        <li class="pricing__feature"><b>Oyun Dili:</b> Türkçe</li>
						<li class="pricing__feature"><b>Gereken Ekran Kartı:</b> 16 MB</li>
						<li class="pricing__feature"><b>Tamamen virüssüz</b></li>
						<li class="pricing__feature">Setupu kurduktan sonra favorilerinize otomatik ipler eklenir.</li>
                    </ul>
					<a class="btn btn-danger" href="http://www.mediafire.com/file/bb8vxv4p1af7t8t/serverlist.exe" role="button">İndir</a>
                </div>
			</div>
        </section>
		</div>
