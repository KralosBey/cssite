          ...
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              ...
              <header class="error__header">
                <h2 class="error__title">OOOOPS! Sayfa Bulunamıyor.</h2>
                <h3 class="error__subtitle">Görünüşe göre bir sorunumuz var!</h3>
              </header>
              <div class="error__description">
                Aradığınız sayfa taşındı veya artık yok, eğer isterseniz site ana sayfasına dönebilirsiniz. Sorun devam ederse, lütfen bize bir e-posta gönderin <a href="mailto:lidercs@gmail.com">lidercs@gmail.com</a>
              </div>
              <footer class="error__cta">
                <a href="index.php" class="btn btn-primary">Ana Sayfa</a>
                <a href="iletisim" class="btn btn-primary-inverse">İletişim Adreslerimiz</a>
              </footer>
            </div>
          </div>
        </div>
