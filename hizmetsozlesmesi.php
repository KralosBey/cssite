...
<head>
  ...
  ================================================== -->
  <title>Hizmet Sözleşmesi - LiderCS Online Oyun Sunucusu</title>
          ...
          <div class="header__primary-inner">
            ...
            <nav class="main-nav clearfix">
              <ul class="main-nav__list">
                <li class=""><a href="index.php"><i class="fa fa-home"></i> AnaSayfa</a></li>
                <li class=""><a href="#Counter-Strike"><i class="fa fa-line-chart"></i> Counter-Strike 1.6</a>
					<ul class="main-nav__sub">
						<li class=""><a href="cs-16-server-listesi-tum-serverler.php"><i class='fa fa-bar-chart' aria-hidden='true'></i> Counter-Strike 1.6 Server Listesi</a></li>
                ...
                <li class=""><a href="#TeamSpeak3"><i class="fa fa-headphones"></i> TeamSpeak3</a>
					<ul class="main-nav__sub">
						<li class=""><a href="teamspeak-sunucu-listesi-tum-sunucular.php"><i class='fa fa-bar-chart' aria-hidden='true'></i> TeamSpeak3 Sunucu Listesi</a></li>
	...
	<div class="container">
        ...
        <div class="content col-md-12">
            ...
            <article class="card card--lg post post--single">
				...
				<center><h1>Hizmet Sözleşmesi</h1></center>
				<p>
				...
				<br>
				<b>Sipariş formunda belirtilen e-posta adresi tebligat adresi olarak kabul edilir.</b>
				</p>
				<h4>Madde 2 – Sözleşmenin Kabulü</h4>
				<p>
				...
				<h4>Madde 3 – Hizmet İçeriği</h4>
				<p>
				LiderCS adresindeki web sitesinde, satışta olan web yazılımları ve ona bağlı tüm ek hizmetler LiderCS’nin malıdır ve onun tarafından işletilir.<br>
				LiderCS, fiyatlar ve sunulan ürün ve hizmetler ile sözleşmeler üzerinde değişiklik yapma hakkını her zaman saklı tutar.<br>
				LiderCS sunucu paketlerinin 1 (bir) aylık kullanım hakkını yalnızca LideRCS sunucularında kullanılmak üzere satın alınması için LiderCS  ile Müşteri arasında yapılan bir sözleşmedir.<br>
				Bu sözleşme Müşterinin LideRCS web sitesi üzerinden sipariş (satın alma) formunu doldurup onaylanması ile başlar, Müşterinin seçtiği paketin teslimi yapılarak faaliyete girmesiyle 1 aylık süreç başlar.<br>
				Müşteri, 1 (bir) aysonunda Kredi kartı/Banka havalesi – Eft ile, LiderCS hesabına paket tutarını yatırarak ve bu ödemesini LiderCS'ye E-Posta ile bildirmesiyle ise bu sözleşme yenilenmiş sayılır.<br>
				...
				Müşteri CS Sunucusu hizmeti alırken, LiderCS sunucularındaki Barındırma sistemini, E-posta sistemini, programları aynen kabul etmiş sayılır.<br>
				Müşteri, satın alacağı pakete ek olarak veri girişi, güncellenmesi, modül, özel istek ve düzenlemeler için LiderCS'nin belirleyeceği ücreti ayrıca ödeyeceğini kabul ve beyan eder.<br>
				Müşteri Cs Sunucusuna sonradan yaptıracağı ek modül, istek ve düzenlemeler ile ilgili hak talebinde bulunamaz. Müşteri serverin sadece kullanım lisansını almaktadır. Sonradan yaptırdığı ek modül ve isteklerin sadece kullanım hakkını satın almaktadır. Böylelikle müşterinin yapılan ek modül, düzenleme ve isteklerin bir benzerinin başka bir müşteri eklenmemesi veya genel satışta kullanılmamasını talep etme hakkı yoktur. (Eğer ek bir sözleşme veya anlaşma yok ise.)<br>
				...
				<h4>Madde 4 – Hak ve Sorumluluklar</h4>
				<p>
				Müşteri, bu sözleşme süresi boyunca aldığı hizmetin kullanım hakkına sahip olur. Dolayısı ile kiraladığı / aldığı ürün veya hizmeti üçüncü şahıslara veya kuruluşlara devredemez, kiralayamaz satamaz.<br>
				Müşteri, CS Sunucusunda telif ve lisans haklarına muhalif içerik veya reklam yayınlayamaz.<br>
				...
				Müşteri, almış olduğu ürüne yönelik yazılımsal değişiklik talep edemez. LiderCS’nin ürünler üzerinde yaptığı genel güncellemelerden kullanıcı yararlanabilir.<br>
				LiderCS, Müşterilerine sözleşme konusu ürünlerden, teknik zaruretler ve mücbir sebepler dışında her zaman ulaşılabilir olmasını garanti eder.<br>
				Müşteri LiderCS ürünlerinin kullanımında, tersine mühendislik yapmayacağını ya da bunların kaynak kodunu bulmak veya elde etmek amacına yönelik herhangi bir başka faaliyetlerde bulunmayacağını kabul ve taahhüt eder. Aksi halde bu faaliyetin tespiti halinde, o anki satın almış olduğu tüm ürünler ile müşteri hesabının iptal edileceğini ve hiçbir şekilde geri ödeme yapılmayacağını kabul ve beyan eder.<br>
				...
				<h4>Madde 5 – Ücret ve Ödemeler</h4>
				<p>
				İş bu sözleşmeye konu olan web sitesi satış fiyatı ücreti sipariş formunun bulunduğu ilgili sayfalarda belirtilmiş olup sipariş esnasında o anki bedeller üzerinden hesaplanır. Müşteri bu ücreti Kredi Kartı veya banka havalesi ile ödemesi durumunda takip eden 24 saat içerisinde web sitesi aktif edilir.<br>
				Bunun sonucunda Müşteriden Sözleşmenin Kapsadığı Yıl İçerisinde BAŞKA İLAVE HİÇ BİR ÜCRET TALEP EDİLMEZ.<br>
				Ücret aylık CS sunucusu kullanımı, LiderCS sunucularında 1 (bir) aylık kullanım hakkını kapsayan ücrettir.
				</p>
				<h4>Madde 6 – Fikri Mülkiyet Hakları</h4>
				<p>
				...
				Lidercs.net adresindeki web sitesinde yer alan tüm ürünler hiçbir şekilde çoğaltılamaz, yayınlanamaz, kopyalanamaz ve aktarılamaz. Site’nin bütünü veya bir kısmı diğer bir internet sitesinde izinsiz olarak kullanılamaz.<br>
				...
				<h4>Madde 8 – Sözleşmenin Feshi</h4>
				<p>
				Müşteri, kullanım süresi sonunda web sitesi hizmetini almak istemediği takdirde Web Sitesi’ni yenilemez ve sözleşme feshedilmiş sayılır.<br>
				Müşteri’nin, Web Sitesi’ni sözleşmeye aykırı bir biçimde kullanımının tespiti halinde LiderCS sözleşmeyi tek taraflı olarak feshedebilir. Sözleşmenin feshi halinde önceki dönemlere ait ödemeler Müşteri’ye iade edilmeyecektir.<br>
				Lidercs.net , 1 (bir) aylık sürenini bitimine an az 1 (bir) günE-Posta ve SMS aracılığıyla tebligat yaparak, bir sonraki döneme ait hizmetin süresinin uzaması ile ilgili hatırlatma yapar.<br>
				</p>
				<h4>Madde 9 – Sözleşmede yapılacak değişiklikler</h4>
				<p>
				...
				<h4>Madde 11 – Sözleşmenin Bütünlüğü ve Uygulanabilirlik</h4>
				<p>
				İşbu sözleşme şartlarından biri, kısmen veya tamamen geçersiz hale gelirse, sözleşmenin geri kalanı geçerliliğini korumaya devam eder.
				</p>
				<h4>Madde 12 – Ceza Hükümleri, Uyuşmazlıkların çözümü</h4>
				<p>
