...
<head>
  ...
  ================================================== -->
  <title>Banka Ödeme - LiderCS Online Oyun Sunucusu</title>
...
<body class="template-football">
  ...
  $s = isset($_GET['sunucu']) ? $_GET['sunucu'] : "";

  if     (is_numeric($s)) { $lgsl_server_id = $s; require ""; }
  elseif ($s == "add")    {                       require "";     }
  else                    {                       require "cs_lgsl_system/lgsl_list2.php";    }
          ...
          <div class="header__primary-inner">
            ...
            <nav class="main-nav clearfix">
              <ul class="main-nav__list">
                ...
                <li class="active"><a href="banka-odeme.php"><i class="fa fa-cc-mastercard"></i> Banka Ödeme</a></li>
  ...
  <!-- İçerik Taşıyıcı
    ...
    <div class="site-content">
	 ...
	 <section class="pricing-section bg-10">
            <h2 class="pricing-section__title">Banka Hesapları</h2>
            <div class="pricing pricing--rabten">
                <div class="pricing__item">
                    <h3 class="pricing__title">Finans Bank</h3>
                    <ul class="pricing__feature-list">
                        <li class="pricing__feature"><b>İsim:</b> Furkan Yaka</li>
                        <li class="pricing__feature">TR12 0011 1000 0000 0051 1796 26</li>
                        <li class="pricing__feature"><b>Şube</b> Bakırköy</li>
						<li class="pricing__feature"><b>Hesap No:</b> 32626685</li>
						<li class="pricing__feature">Lütfen Ödeme Bildirimi Yapmayı Unutmayınız</li>
                    </ul>
                    <a class="btn btn-danger" href="http://fb.com/lidercs1" role="button">Ödeme Bildirimi Yap &raquo;</a>
                </div>
				
				<div class="pricing__item">
                    <h3 class="pricing__title">Garanti Bankası</h3>
                    <ul class="pricing__feature-list">
                        <li class="pricing__feature"><b>İsim:</b> Furkan Yaka</li>
                        <li class="pricing__feature">TR27 0006 2000 7440 0006 6138 55</li>
                        <li class="pricing__feature"><b>Şube</b> Yeşilbağ / 744</li>
						<li class="pricing__feature"><b>Hesap No:</b> 6613855</li>
						<li class="pricing__feature">Lütfen Ödeme Bildirimi Yapmayı Unutmayınız</li>
                    </ul>
					<a class="btn btn-danger" href="http://fb.com/lidercs1" role="button">Ödeme Bildirimi Yap &raquo;</a>
                </div>
				...
				<div class="pricing__item">
                    <h3 class="pricing__title">Yapı Kredi</h3>
                    <ul class="pricing__feature-list">
                        <li class="pricing__feature"><b>İsim:</b> Furkan Yaka</li>
                        <li class="pricing__feature">TR05 0006 7010 0000 0044 5147 63 6138 55</li>
                        <li class="pricing__feature"><b>Şube</b> Bağcılar Çiftlik / 860</li>
						<li class="pricing__feature"><b>Hesap No:</b> 44514763</li>
						<li class="pricing__feature">Lütfen Ödeme Bildirimi Yapmayı Unutmayınız</li>
                    </ul>
                    <a class="btn btn-danger" href="http://fb.com/lidercs1" role="button">Ödeme Bildirimi Yap &raquo;</a>
                </div>
				...
				<div class="pricing pricing--rabten">
				<div class="pricing__item">
                    <h3 class="pricing__title">İş Bankası</h3>
                    <ul class="pricing__feature-list">
                        <li class="pricing__feature"><b>İsim:</b> Furkan Yaka</li>
                        <li class="pricing__feature">TR050006400000111230876860</li>
                        <li class="pricing__feature"><b>Şube</b> 1123 / Bakırköy</li>
						<li class="pricing__feature"><b>Hesap No:</b> 0876860</li>
						<li class="pricing__feature">Lütfen Ödeme Bildirimi Yapmayı Unutmayınız</li>
                    </ul>
                    <a class="btn btn-danger" href="http://fb.com/lidercs1" role="button">Ödeme Bildirimi Yap &raquo;</a>
                </div>
				...
				<div class="pricing__item">
                    <h3 class="pricing__title">PTT</h3>
                    <ul class="pricing__feature-list">
                        <li class="pricing__feature"><b>İsim:</b> Furkan Yaka</li>
                        <li class="pricing__feature"><b>Şube</b> Bağcılar</li>
						<li class="pricing__feature"><b>Hesap No:</b> 14205986</li>
						<li class="pricing__feature">Lütfen Ödeme Bildirimi Yapmayı Unutmayınız</li>
                    </ul>
                    <a class="btn btn-danger" href="http://fb.com/lidercs1" role="button">Ödeme Bildirimi Yap &raquo;</a>
                </div>
				...
				<div class="pricing__item">
                    <h3 class="pricing__title">İninal</h3>
                    <ul class="pricing__feature-list">
                        <li class="pricing__feature"><b>İsim:</b> Furkan Yaka</li>
                        <li class="pricing__feature"><b>No:</b> 5157 5570 1651 4514</li>
						<li class="pricing__feature">Lütfen Ödeme Bildirimi Yapmayı Unutmayınız</li>
                    </ul>
                    <a class="btn btn-danger" href="http://fb.com/lidercs1" role="button">Ödeme Bildirimi Yap &raquo;</a>
                </div>
