...
<?php
//------------------------------------------------------------------------------------------------------------+
  require "../ts3_lgsl_system/lgsl_config.php";
session_start();
ob_start();
...
<head>
  ...
  <!-- Basic Page Needs
  ================================================== -->
  <title>LiderCs.Net | TeamSpeak3 Admin Paneli</title>
  <!-- Google Web Fonts
  ================================================== -->
...
//------------------------------------------------------------------------------------------------------------+
  if (defined("LGSL_ADMIN"))
  {
    global $output;
    $output = "";
    require "../ts3_lgsl_system/lgsl_admin.php";
    echo $output;
  }
  else
  {
	...
	<h1 class='nk-decorated-h-2'><span><span class='text-main-1'>MrStipFan</span> Designer</span></h1>
                <div class='card'>
                    <div class='card__header'>
                        ...
                        <div style='text-align:right'><a href='../index.php' class='btn btn-default btn-outline btn-sm'>Sunucu Listesine Geri Dön</a></div>
                    </div>
